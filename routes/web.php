...
Route::group(['middleware' => ['auth']], function () {
   ...
   Route::get('classroom/create/room/{room}', 'ClassroomController@create')->name('classroom.create');
   Route::resource('classroom', 'ClassroomController')->except(['index','create']);
   Route::get('classrooms/students/{classroom}', 'ClassroomController@showStudents')->name('classroom.students');
