    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin')
                ...
                <li class="{{ setActive(['user.guru', 'users/create/Guru']) }}"><a href="{{ route('user.guru') }}"><i class="icon icon-account_circle s-18 text-green"></i>Guru</a></li>
                <li class="{{ setActive(['user.siswa',route('users.create',['name'=>'Siswa'])]) }}"><a href="{{ route('user.siswa') }}"><i class="icon icon-account_circle s-18 text-green"></i>Siswa</a></li>
                <li class="{{ setActive(['room.*'])}}"><a href="{{ route('room.index') }}"><i class="icon icon-class s-18 text-green"></i>Kelas</a></li>
            @endcan
            <li class="header">
                <strong>Akun</strong>
            </li>
